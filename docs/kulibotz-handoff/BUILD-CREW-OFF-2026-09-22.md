...
| The Tech Room hub | https://apps.kulibert.net | GitHub `trebiluk/apps-kulibert` | Vercel **apps-kulibert** | rev **2026-09-22-hub-shadcn-shell** (density + Stark shell PASS) |
...
| PaperLab | https://apps.kulibert.net/paperlab/ | apps-kulibert | Hub | **P0 class tomorrow** — see below |
...
## P0 RIGHT NOW — PaperLab for tomorrow’s class

Diego bar: **every plan** must have **diagrams + examples or step guides** so kids do not need the teacher.

- FAIL example: https://apps.kulibert.net/paperlab/plans/envelope (was missing envelope pictures)
...
- Wire into live plan pages under apps-kulibert PaperLab; prove envelope first, then batch the rest
- Side-pane polish is **secondary** to instructional visuals

If crew is off: **Build owns grafting steps + diagrams into live PaperLab and publishing apps-kulibert.**
...
5. Chromebook mid/low first · TW **Dream dark** (no white walls) · Hub/Baboo **Stark** · never mix Stark+Dream on one surface.
...
- Tokens: `shared/brand/kulinet/shadcn-kulinet-tokens.css`
- Map: `shared/apps-hub/crew-reports/STYLEBOT-SHADCN-KULINET-MAP.md`
- Live shell AFTER shots: `shared/apps-hub/visual-eval/hub-shadcn-shell-*-AFTER-2026-09-22.png`
- Diego GO: full Hub shell on KuliNet Stark (done live); further hub polish OK without re-asking that GO
...
> You are Grok Build for Kulibert Tech Ed (Solvay). Crew may be OFF. Follow `GROK-BUILD-WHEN-CREW-OFF.md` (this paste / repo docs). Ship to `*.kulibert.net` only. Chromebook-first. TW Dream dark; Hub/Baboo Stark. Current P0 if still open: PaperLab plan diagrams+guides for class (envelope first). Publish via the correct GitHub→host path. Prefer Claude newest. Do not wait on Flo/Debugzy/StyleBot.
